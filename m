...
Received: from bombadil.infradead.org (bombadil.infradead.org [IPv6:2607:7c80:54:e::133])
	by mail.lfdr.de (Postfix) with ESMTPS id 80CB81355F4
	for <lists+linux-rockchip@lfdr.de>; Thu,  9 Jan 2020 10:40:36 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	References:List-Owner; bh=RB6GhAdhASxVNM/04gGUCGtDnTE/UVsHMy2E/sKgv1A=; b=Zuf
	;
Received: from localhost ([127.0.0.1] helo=bombadil.infradead.org)
	by bombadil.infradead.org with esmtp (Exim 4.92.3 #3 (Red Hat Linux))
	id 1ipUIo-0006VQ-1W; Thu, 09 Jan 2020 09:40:30 +0000
Received: from lucky1.263xmail.com ([211.157.147.132])
 by bombadil.infradead.org with esmtps (Exim 4.92.3 #3 (Red Hat Linux))
 id 1ipUIc-0006Jy-FW; Thu, 09 Jan 2020 09:40:27 +0000
Received: from localhost (unknown [192.168.167.235])
 by lucky1.263xmail.com (Postfix) with ESMTP id 283F78AAD8;
 Thu,  9 Jan 2020 17:40:08 +0800 (CST)
X-MAIL-GRAY: 0
X-MAIL-DELIVERY: 1
X-ADDR-CHECKED4: 1
X-ANTISPAM-LEVEL: 2
...
Received: from localhost.localdomain (unknown [58.22.7.114])
 ...
 P25813T139965927253760S1578562806897506_; 
 Thu, 09 Jan 2020 17:40:08 +0800 (CST)
X-IP-DOMAINF: 1
X-UNIQUE-TAG: <7fff3bcc381c07bf1dd7b1a39479e2b4>
...
Subject: [PATCH] pinctrl/rockchip: splite soc data to separated driver
Date: Thu,  9 Jan 2020 17:40:01 +0800
Message-Id: <20200109094001.24343-1-jay.xu@rock-chips.com>
X-Mailer: git-send-email 2.17.1
X-Spam-Note: CRM114 run bypassed due to message size (135588 bytes)
X-Spam-Score: 1.5 (+)
...
---
 ...
 drivers/pinctrl/rockchip/Kconfig            |  123 ++
 drivers/pinctrl/rockchip/Makefile           |   16 +
 drivers/pinctrl/rockchip/pinctrl-px30.c     |  217 ++
 drivers/pinctrl/rockchip/pinctrl-rk2928.c   |   62 +
 drivers/pinctrl/rockchip/pinctrl-rk3036.c   |   61 +
 drivers/pinctrl/rockchip/pinctrl-rk3066.c   |   64 +
 drivers/pinctrl/rockchip/pinctrl-rk3066b.c  |   43 +
 drivers/pinctrl/rockchip/pinctrl-rk3128.c   |  153 ++
 drivers/pinctrl/rockchip/pinctrl-rk3188.c   |   84 +
 drivers/pinctrl/rockchip/pinctrl-rk3228.c   |  217 ++
 drivers/pinctrl/rockchip/pinctrl-rk3288.c   |  159 ++
 drivers/pinctrl/rockchip/pinctrl-rk3308.c   |  407 ++++
 drivers/pinctrl/rockchip/pinctrl-rk3328.c   |  265 +++
 drivers/pinctrl/rockchip/pinctrl-rk3368.c   |  118 ++
 drivers/pinctrl/rockchip/pinctrl-rk3399.c   |  192 ++
 drivers/pinctrl/rockchip/pinctrl-rockchip.c | 2093 +++++++++++++++++++
 drivers/pinctrl/rockchip/pinctrl-rockchip.h |  390 ++++
 drivers/pinctrl/rockchip/pinctrl-rv1108.c   |  205 ++
 21 files changed, 4873 insertions(+), 11 deletions(-)
...
index fc9a2a9959d9..c6ab1e3754dc 100644
--- a/drivers/pinctrl/pinctrl-rockchip.c
+++ b/drivers/pinctrl/pinctrl-rockchip.c
@@ -3556,12 +3556,11 @@ static int rockchip_get_bank_data(struct rockchip_pin_bank *bank,
...
index 000000000000..84df1c95f9be
--- /dev/null
...
+	  SoCs on Rockchip platform.
+
+config PINCTRL_RK3066
+	tristate "RK3066 pin controller driver"
+	depends on GPIOLIB && OF
+	select PINCTRL_ROCKCHIP
+	help
+	  This is the pinctrl, pinmux, pinconf and gpiolib driver for the
...
new file mode 100644
index 000000000000..472c0afa3106
--- /dev/null
...
+obj-$(CONFIG_PINCTRL_RK3066)	+= pinctrl-rk3066.o
...
new file mode 100644
index 000000000000..f2b6ad75d777
--- /dev/null
...
+};
+
+static int px30_pinctrl_probe(struct platform_device *pdev)
+{
+	return rockchip_pinctrl_probe(pdev, &px30_pin_ctrl);
+}
+
+static struct platform_driver px30_pinctrl_driver = {
+	.probe		= px30_pinctrl_probe,
+	.driver = {
+		.name	= "px30-pinctrl",
...
new file mode 100644
index 000000000000..3e035e139c82
--- /dev/null
...
+};
+
+static int rk2928_pinctrl_probe(struct platform_device *pdev)
+{
+	return rockchip_pinctrl_probe(pdev, &rk2928_pin_ctrl);
+}
+
+static struct platform_driver rk2928_pinctrl_driver = {
+	.probe		= rk2928_pinctrl_probe,
+	.driver = {
+		.name	= "rk2928-pinctrl",
+		.pm = &rockchip_pinctrl_dev_pm_ops,
...
new file mode 100644
index 000000000000..a2d0f4a36da6
--- /dev/null
...
+};
+
+static int rk3036_pinctrl_probe(struct platform_device *pdev)
+{
+	return rockchip_pinctrl_probe(pdev, &rk3036_pin_ctrl);
+}
+
...
new file mode 100644
index 000000000000..407eef4fcff6
--- /dev/null
...
+#include "pinctrl-rockchip.h"
+
+#define RK3066_PULL_GRF_OFFSET		0x118
...
+		.type			= RK2928,
+		.grf_mux_offset		= 0xa8,
+		.pull_calc_reg		= rk3066_calc_pull_reg_and_bit,
+};
+
+static const struct of_device_id rk3066_pinctrl_dt_match[] = {
+	{ .compatible = "rockchip,rk3066-pinctrl" },
+	{},
+};
+
+static int rk3066_pinctrl_probe(struct platform_device *pdev)
+{
+	return rockchip_pinctrl_probe(pdev, &rk3066_pin_ctrl);
+}
+
+static struct platform_driver rk3066_pinctrl_driver = {
+	.probe		= rk3066_pinctrl_probe,
+	.driver = {
+		.name	= "rk3066-pinctrl",
+		.pm = &rockchip_pinctrl_dev_pm_ops,
+		.of_match_table = rk3066_pinctrl_dt_match,
+	},
+};
+
+static int __init rk3066_pinctrl_init(void)
+{
+	return platform_driver_register(&rk3066_pinctrl_driver);
+}
...
new file mode 100644
index 000000000000..96dd4749e881
--- /dev/null
...
+};
+
+static int rk3066b_pinctrl_probe(struct platform_device *pdev)
+{
+	return rockchip_pinctrl_probe(pdev, &rk3066b_pin_ctrl);
+}
+
+static struct platform_driver rk3066b_pinctrl_driver = {
+	.probe		= rk3066b_pinctrl_probe,
+	.driver = {
...
new file mode 100644
index 000000000000..7f06e6306d40
--- /dev/null
...
+};
+
+static int rk3128_pinctrl_probe(struct platform_device *pdev)
+{
+	return rockchip_pinctrl_probe(pdev, &rk3128_pin_ctrl);
+}
+
...
new file mode 100644
index 000000000000..5e803ad70e70
--- /dev/null
...
+{
+	return rockchip_pinctrl_probe(pdev, &rk3188_pin_ctrl);
+}
+
...
new file mode 100644
index 000000000000..562a807a062c
--- /dev/null
...
+};
+
+static int rk3228_pinctrl_probe(struct platform_device *pdev)
+{
+	return rockchip_pinctrl_probe(pdev, &rk3228_pin_ctrl);
+}
+
+static struct platform_driver rk3228_pinctrl_driver = {
+	.probe		= rk3228_pinctrl_probe,
+	.driver = {
+		.name	= "rk3228-pinctrl",
+		.pm = &rockchip_pinctrl_dev_pm_ops,
...
new file mode 100644
index 000000000000..1f2b6a1e3f8f
--- /dev/null
...
+};
+
+static int rk3288_pinctrl_probe(struct platform_device *pdev)
+{
+	return rockchip_pinctrl_probe(pdev, &rk3288_pin_ctrl);
+}
+
...
new file mode 100644
index 000000000000..f4aa67831173
--- /dev/null
...
+};
+
+static int rk3308_pinctrl_probe(struct platform_device *pdev)
+{
+	return rockchip_pinctrl_probe(pdev, &rk3308_pin_ctrl);
+}
+
...
new file mode 100644
index 000000000000..09cfee5601f7
--- /dev/null
...
+};
+
+static int rk3328_pinctrl_probe(struct platform_device *pdev)
+{
+	return rockchip_pinctrl_probe(pdev, &rk3328_pin_ctrl);
+}
+
...
new file mode 100644
index 000000000000..2c76604f1dd9
--- /dev/null
...
+};
+
+static int rk3368_pinctrl_probe(struct platform_device *pdev)
+{
+	return rockchip_pinctrl_probe(pdev, &rk3368_pin_ctrl);
+}
+
...
new file mode 100644
index 000000000000..0b9fd2eb0e3d
--- /dev/null
...
+};
+
+static int rk3399_pinctrl_probe(struct platform_device *pdev)
+{
+	return rockchip_pinctrl_probe(pdev, &rk3399_pin_ctrl);
+}
+
...
new file mode 100644
index 000000000000..f54eee703d44
--- /dev/null
...
+
+int __maybe_unused rockchip_pinctrl_suspend(struct device *dev)
+{
...
+	return 0;
+}
+EXPORT_SYMBOL(rockchip_pinctrl_suspend);
+
+int __maybe_unused rockchip_pinctrl_resume(struct device *dev)
+{
+	struct rockchip_pinctrl *info = dev_get_drvdata(dev);
...
+}
+EXPORT_SYMBOL(rockchip_pinctrl_resume);
+
+int rockchip_pinctrl_probe(struct platform_device *pdev,
+			   struct rockchip_pin_ctrl *pctrl)
+{
+	struct rockchip_pinctrl *info;
+	struct device *dev = &pdev->dev;
+	struct rockchip_pin_ctrl *ctrl;
...
+	info->dev = dev;
+
+	ctrl = rockchip_pinctrl_get_soc_data(info, pdev, pctrl);
+	if (!ctrl) {
...
+};
+
+int __maybe_unused rockchip_pinctrl_probe(struct platform_device *pdev,
+					  struct rockchip_pin_ctrl *pctrl);
+int __maybe_unused rockchip_pinctrl_resume(struct device *dev);
+int __maybe_unused rockchip_pinctrl_suspend(struct device *dev);
+
...
new file mode 100644
index 000000000000..9343fcddbe44
--- /dev/null
...
+};
+
+static int rv1108_pinctrl_probe(struct platform_device *pdev)
+{
+	return rockchip_pinctrl_probe(pdev, &rv1108_pin_ctrl);
+}
+
